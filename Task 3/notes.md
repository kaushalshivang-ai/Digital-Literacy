# Task 3: Coding & Collaboration Platforms - Activity Notes

## Part A: Coding Practice
* **Platform Used:** HackerRank
* **Activity:** Completed the beginner-level Python introductory challenge to build familiarity with algorithmic problem-solving interfaces and basic syntax.
* **Proof:** The successful test case execution and completion screen are documented in the `hackerrank-completion.png` screenshot included in this folder.
